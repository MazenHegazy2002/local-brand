...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    href: process.env.NEXT_PUBLIC_INSTAGRAM_URL || 'https://www.instagram.com/brandyy.eg/',
    icon: (
  ...
  {
    name: 'TikTok',
    href: process.env.NEXT_PUBLIC_TIKTOK_URL || 'https://www.tiktok.com/@brandyyeg/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {CONTACT_WHATSAPP && (
                <div className="pt-2">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#128C7E] hover:bg-[#075E54] text-white text-xs font-bold shadow-sm transition-all hover:scale-[1.02]"
                  >
