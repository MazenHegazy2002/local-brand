...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  {
    key: 'BUYER_POPUP_ENABLED',
    category: 'maintenance',
    type: 'toggle',
    label: 'Enable Buyer Pop-up Message',
    labelAr: 'تفعيل النوافذ المنبثقة للمشترين',
    defaultValue: false,
    description: 'Displays a popup message modal to buyers visiting the store or dashboard.',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_TITLE',
    category: 'maintenance',
    type: 'text',
    label: 'Pop-up Title (English)',
    labelAr: 'عنوان النافذة المنبثقة (إنجليزي)',
    defaultValue: 'Important Notice',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_TITLE_AR',
    category: 'maintenance',
    type: 'text',
    label: 'Pop-up Title (Arabic)',
    labelAr: 'عنوان النافذة المنبثقة (عربي)',
    defaultValue: 'تنويه هام',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_MESSAGE',
    category: 'maintenance',
    type: 'longtext',
    label: 'Pop-up Message (English)',
    labelAr: 'نص الرسالة المنبثقة (إنجليزي)',
    defaultValue: 'Welcome to our store! Check out our latest deals.',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_MESSAGE_AR',
    category: 'maintenance',
    type: 'longtext',
    label: 'Pop-up Message (Arabic)',
    labelAr: 'نص الرسالة المنبثقة (عربي)',
    defaultValue: 'أهلاً بك في متجرنا! تفقد أحدث عروضنا وتخفيضاتنا اليوم.',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_TYPE',
    category: 'maintenance',
    type: 'select',
    label: 'Pop-up Style / Banner Type',
    labelAr: 'نوع وشكل النافذة المنبثقة',
    defaultValue: 'info',
    choices: [
      { value: 'info', label: 'ℹ️ Information (Blue)' },
      { value: 'warning', label: '⚠️ Warning (Amber)' },
      { value: 'danger', label: '🚨 Urgent Alert (Red)' },
      { value: 'success', label: '🎉 Special Offer / Announcement (Green)' },
    ],
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    key: 'BUYER_POPUP_TARGET',
    category: 'maintenance',
    type: 'select',
    label: 'Target Audience / Pages',
    labelAr: 'جمهور ونطاق عرض الرسالة',
    defaultValue: 'all',
    choices: [
      { value: 'all', label: 'All Storefront & Dashboard Visitors' },
      { value: 'dashboard', label: 'Dashboard Pages Only (/dashboard)' },
      { value: 'logged_in', label: 'Logged-in Buyers Only' },
    ],
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
    ...
    category: 'maintenance',
    type: 'text',
    label: 'Pop-up Version ID',
    labelAr: 'معرف نسخة النافذة المنبثقة',
    defaultValue: 'v1',
    description:
      'Change this ID (e.g. v2) to force the popup to appear again for users who closed the previous version.',
    group: 'Buyer Announcement Pop-up',
    exposeToClient: true,
  },
  {
