...
// ISR: revalidate every 5 minutes (categories change rarely)
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${PLATFORM_URL}/categories`,
    languages: {
      'ar-EG':
        'تصفح جميع فئات المنتجات على Brandy. تسوق الإلكترونيات والموضة والجمال ومستلزمات المنزل وأكثر من البائعين المصريين الموثوقين.',
    },
  },
  openGraph: {
    title: 'All Categories',
...
function iconFor(name: string) {
  ...
  if (lower === 'appliances' || lower.includes('applian') || lower.includes('machine'))
  ...
  if (
    ...
    return <PharmaIcon />;
  if (lower === 'sports' || lower === 'sport' || lower.includes('sport') || lower.includes('gym'))
    return <SportsIcon />;
  ...
  return (
    <main className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <div className="container mx-auto px-4 py-10 md:py-14">
        <div className="mb-10">
          <p className="text-xs uppercase tracking-[0.2em] text-[hsl(var(--accent))] font-semibold mb-2">
            Browse
          </p>
